...
<div id="myCarousel" class="carousel slide">
    ...
    <a class="carousel-control left" href="#myCarousel" 
       data-slide="prev">
    <img src="images/left-arrow.png" alt="" style="margin-top: 160px;">
    </a>
    <a class="carousel-control right" href="#myCarousel" 
       data-slide="next">
       <img src="images/right-arrow.png" alt="" style="margin-top: 160px;">
    </a>
 </div>
		...
		<div class="title">
		 ...
		 <div class="container">
			...
			?>
		        ...
		        <!--  <div class="col-lg-4"><div class="pic"><img src="images/2.jpg" alt=""><h4>区域卫计生管理</h4></div></div>
		        <div class="col-lg-4"><div class="pic"><img src="images/3.jpg" alt=""><h4>智慧教育</h4></div></div> -->
            ...
            $row = $dosql->GetOne("SELECT * FROM pmw_infolist WHERE classid=16 AND  delstate='' AND checkinfo=true ORDER BY orderid ASC   LIMIT 0,1 "); ?>
                <div class="col-lg-6">
	                <aside class="news-left">
				         <a href=" newsshow.php?cid=16&id=34"><img src="<?php echo $row['picurl']; ?>"></a>
